 ...
 * 参数名称的几种可能
 * <p>1. @Param注解获取
 * <p>2. 系统默认名称arg0、arg1、arg2
 * <p>3. "0", "1", "2"
 * <p>4. param1, param2, param3
 */
public class ParamNameResolver {
    ...
    for (int paramIndex = 0; paramIndex < paramCount; paramIndex++) {
      ...
      if (name == null) {
        ...
        if (useActualParamName) {
          //如果为空，且允许useActualParamName，则使用系统默认的参数名称为name：arg0、arg1、arg2
  ...
  public Object getNamedParams(Object[] args) {
    ...
    if (!hasParamAnnotation && paramCount == 1) {
      //注意，这里可能会直接返回本体
      //没有使用@Param，且只有一个参数-->直接返回原对象
      Object value = args[names.firstKey()];
      //如果是集合或者数组，参数需要包装一下（map），否则直接返回参数
